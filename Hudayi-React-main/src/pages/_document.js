    ...
    return (
      <Html lang="en" className={primaryFont.className}>
        <Head>
          ...
          <meta
            name="description"
            content="The starting point for your next project with Hudayi Kit, built on the newest version of Material-UI ©, ready to be customized to your style"
          />
          <meta name="keywords" content="react,material,kit,application,dashboard,admin,template" />
          <meta name="author" content="Hudayi Kit" />
        </Head>
