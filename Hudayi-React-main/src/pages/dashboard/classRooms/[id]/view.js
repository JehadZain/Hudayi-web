...
function formatTimeElapsed(updatedAt, translate) {
  const now = new Date();
      ...
      if (isMounted) {
        ...
        const statisticsWidgetsData = [
          <StatWidget
            ...
            title="students.approvedStudents"
            stats={{ 'students.approvedStudents': classRoomData?.statistics.find((s) => s.name === 'Approved Students')?.count || 0 }}
            translate={translate}
            theme={theme}
          />,
          <StatWidget
          ...
          <StatWidget
            key="interviews"
            title="students.personalInterviews"
            stats={{ 'students.personalInterviews': classRoomData?.statistics.find((s) => s.name === 'Personal Interviews')?.count || 0 }}
            translate={translate}
            theme={theme}
          />,
        ];
